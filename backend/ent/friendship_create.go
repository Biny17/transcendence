...
func (_c *FriendshipCreate) SetStatus(v string) *FriendshipCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *FriendshipCreate) SetNillableStatus(v *string) *FriendshipCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *FriendshipCreate) SetUserID(id int) *FriendshipCreate {
