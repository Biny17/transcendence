...
func (_q *GameQuery) QueryResults() *ResultQuery {
...
func (_q *GameQuery) WithResults(opts ...func(*ResultQuery)) *GameQuery {
	query := (&ResultClient{config: _q.config}).Query()
...
func (_q *GameQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Game, error) {
	...
	if query := _q.withResults; query != nil {
		if err := _q.loadResults(ctx, query, nodes,
			func(n *Game) { n.Edges.Results = []*Result{} },
			func(n *Game, e *Result) { n.Edges.Results = append(n.Edges.Results, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *GameQuery) loadResults(ctx context.Context, query *ResultQuery, nodes []*Game, init func(*Game), assign func(*Game, *Result)) error {
