...
func (c *ConversationClient) QueryParticipants(_m *Conversation) *UserQuery {
...
// QueryFriendOf queries the friend_of edge of a User.
func (c *UserClient) QueryFriendOf(_m *User) *FriendshipQuery {
	query := (&FriendshipClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QuerySendMessages queries the send_messages edge of a User.
func (c *UserClient) QuerySendMessages(_m *User) *MessageQuery {
	query := (&MessageClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
