...
func (_c *GameCreate) SetTimeStamp(v time.Time) *GameCreate {
	_c.mutation.SetTimeStamp(v)
	return _c
}

// SetNillableTimeStamp sets the "time_stamp" field if the given value is not nil.
func (_c *GameCreate) SetNillableTimeStamp(v *time.Time) *GameCreate {
	if v != nil {
		_c.SetTimeStamp(*v)
	}
	return _c
...
func (_c *GameCreate) SetType(v string) *GameCreate {
	_c.mutation.SetType(v)
	return _c
}

// SetNbPlayer sets the "nb_player" field.
func (_c *GameCreate) SetNbPlayer(v int) *GameCreate {
	_c.mutation.SetNbPlayer(v)
	return _c
}

// AddResultIDs adds the "results" edge to the Result entity by IDs.
func (_c *GameCreate) AddResultIDs(ids ...int) *GameCreate {
	_c.mutation.AddResultIDs(ids...)
	return _c
}

// AddResults adds the "results" edges to the Result entity.
func (_c *GameCreate) AddResults(v ...*Result) *GameCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GameCreate) check() error {
	if _, ok := _c.mutation.TimeStamp(); !ok {
		return &ValidationError{Name: "time_stamp", err: errors.New(`ent: missing required field "Game.time_stamp"`)}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "Game.type"`)}
	}
	if _, ok := _c.mutation.NbPlayer(); !ok {
		return &ValidationError{Name: "nb_player", err: errors.New(`ent: missing required field "Game.nb_player"`)}
	}
	return nil
}
...
func (_c *GameCreate) createSpec() (*Game, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.NbPlayer(); ok {
		_spec.SetField(game.FieldNbPlayer, field.TypeInt, value)
		_node.NbPlayer = value
	}
