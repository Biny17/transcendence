...
func (_q *ResultQuery) QueryGame() *GameQuery {
...
func (_q *ResultQuery) WithGame(opts ...func(*GameQuery)) *ResultQuery {
	query := (&GameClient{config: _q.config}).Query()
...
func (_q *ResultQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Result, error) {
	...
	if query := _q.withGame; query != nil {
		if err := _q.loadGame(ctx, query, nodes, nil,
			func(n *Result, e *Game) { n.Edges.Game = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ResultQuery) loadGame(ctx context.Context, query *GameQuery, nodes []*Result, init func(*Result), assign func(*Result, *Game)) error {
