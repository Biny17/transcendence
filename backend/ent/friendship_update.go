...
func (_u *FriendshipUpdate) SetStatus(v string) *FriendshipUpdate {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *FriendshipUpdate) SetNillableStatus(v *string) *FriendshipUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *FriendshipUpdate) SetUserID(id int) *FriendshipUpdate {
...
func (_u *FriendshipUpdate) SetFriendID(id int) *FriendshipUpdate {
	_u.mutation.SetFriendID(id)
	return _u
}
...
// SetStatus sets the "status" field.
func (_u *FriendshipUpdateOne) SetStatus(v string) *FriendshipUpdateOne {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *FriendshipUpdateOne) SetNillableStatus(v *string) *FriendshipUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// SetUserID sets the "user" edge to the User entity by ID.
func (_u *FriendshipUpdateOne) SetUserID(id int) *FriendshipUpdateOne {
	_u.mutation.SetUserID(id)
	return _u
}
...
// SetFriendID sets the "friend" edge to the User entity by ID.
func (_u *FriendshipUpdateOne) SetFriendID(id int) *FriendshipUpdateOne {
	_u.mutation.SetFriendID(id)
	return _u
}
