    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ margin: '8px 0 0', fontSize: 14, color: '#888' }}>
          Next.js + Three.js game engine architecture
        </p>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: 280 }}>
        ...
        <p style={{ margin: '-0.5rem 0 0.5rem', fontSize: 11, color: '#555', textAlign: 'center' }}>
          No server · GravityModule · CollisionModule
        </p>
        <Link href="/demo-online" style={{ textDecoration: 'none' }}>
          <button type="button" style={{
            width: '100%',
            padding: '0.9rem 2rem',
            fontSize: '1rem',
        ...
        <p style={{ margin: '-0.5rem 0 0', fontSize: 11, color: '#555', textAlign: 'center' }}>
          Requires server · Lobby → Loading → Parkour
        </p>
      </div>
