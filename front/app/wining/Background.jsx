...
export function Background() {
  ...
  return (
    <div className="h-screen w-screen relative bg-slate-950 flex flex-col items-center justify-center overflow-hidden">
      ...
      {ready && <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 z-30 pointer-events-none">
        <DotLottieReact
      ...
      >
        ...
        {ready && <div className="flex items-center justify-center gap-10">
