...
import Online from "@/components/cards/LeaderboardCard";
import LeaderBoardCard from '@/components/cards/LeaderboardCard';
import { Button } from "../../app/animations/Button.jsx";

const LeaderBoard = ({setLeaderBoardOpen}) => {
return (
    <div
      ...
      <div id="Container">
       ...
       <LeaderBoardCard />
        ...
        <div id="emiter">
          ...
          <div className="mt-6 flex gap-3 justify-center pr-1">
            <Button statement="Go back" onClick={() => setLeaderBoardOpen(false)} />
          </div>
        </div>
      </div>
